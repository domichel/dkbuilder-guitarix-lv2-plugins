// generated from file '../dkbuild/blowmepreampsoft//blowmepreampsoft.dsp' by dsp2cc:
// Code generated with Faust 2.14.4 (https://faust.grame.fr)


namespace blowmepreampsoft {
...
#define fVslider0 (*fVslider0_)
	double fSlow0 = (2.8979565231232145e-10 * (std::exp((17.0 * double(fVslider0))) + -1.0));
...
} // end namespace blowmepreampsoft
